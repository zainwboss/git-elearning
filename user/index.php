                    ...
                    <div class="w-100 w-sm-400px">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../template/../demo1/index.html" action="#">
                            ...
                            <div class="separator separator-content my-14">
                                <h2 class="w-275px w-sm-200px w-lg-250px text-dark fw-bolder mb-3">เข้าสู่ระบบผู้ใช้</h2>
                            </div>
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <a href="../forgetPassword/forget_password.php?status=2" class="link-primary">ลืมรหัสผ่าน ?</a>
                            </div>

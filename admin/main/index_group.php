    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">กลุ่ม</h1>
                <span class="h-20px border-gray-300 border-start mx-4"></span>

                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    <li class="breadcrumb-item text-dark">รายการกลุ่ม</li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    function GetTable() {
        $.ajax({
            type: 'POST',
            url: "ajax/index_group/GetTable.php",
            dataType: "html",
            success: function(response) {
                $("#show_data").html(response);
                var t, e;
                t = document.querySelector("#tbl_group"),
                    e = $(t).DataTable({
                        "scrollX": true,
                    }),
    ...
    function ModalAdd() {
        $.ajax({
            url: "ajax/index_group/ModalAdd.php",
            dataType: "html",
            success: function(response) {
    ...
    function ModalEdit(group_id) {
        $.ajax({
            type: "post",
            url: "ajax/index_group/ModalEdit.php",
            data: {
                group_id: group_id
            },
            dataType: "html",
    ...
    function ChangeStatus(button, group_id) {
        $.ajax({
            type: "post",
            url: "ajax/index_group/ChangeStatus.php",
            data: {
                group_id: group_id
            },
            dataType: "json",

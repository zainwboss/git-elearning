...
<div class="modal-header">
    <h1 class="modal-title">นำเข้าพนักงาน</h1>
...
<div class="modal-body px-10 px-lg-15 ">
    <form id="form_import_user" class="form" action="#">
        <div class="d-flex mb-8">
            <a class="btn btn-sm btn-light-warning btn-hover-rise me-5" href="ajax/index_user/FormImportUser.xlsx">
                ...
                </span>ดาวน์โหลดแบบฟอร์ม
            </a>
            <a class="btn btn-sm btn-light-info btn-hover-rise" onclick="ModalGroupID();">
                <span class="svg-icon svg-icon-muted svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="modal-footer">
    ...
    <button type="button" id="import_submit" class="btn btn-sm btn-primary btn-hover-scale" onclick="ImportUser();">
...
<script>
    var form, validate;
    form = document.querySelector("#form_import_user");
                ...
                if (status == 'Valid') {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            let formData = new FormData($("#form_import_user")[0]);
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'ajax/index_user/ImportUser.php',
                                data: formData,
                                dataType: 'json',
                                cache: false,
                                processData: false,
                                ...
                                success: function(data) {
                                    ...
                                    if (data.result == 1) {
                                        ...
                                        window.location.href = "ajax/index_user/" + data.file_name;
                                    }
                                }
                            })
                        }
    ...
    function ModalGroupID() {
        $.ajax({
            type: "POST",
            url: "ajax/index_user/ModalGroupID.php",
            dataType: "html",
            success: function(response) {
                $("#show_modal").html(response);
                $("#modal").modal('show');
                var t, e;
                t = document.querySelector("#tbl_group_id"),
                    e = $(t).DataTable({
                        "scrollX": true,
                    })

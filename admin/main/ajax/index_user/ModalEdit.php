...
$sql_user_group = "SELECT * FROM tbl_user_group WHERE user_id='$user_id' ORDER BY create_datetime ASC";
$rs_user_group  = mysqli_query($connection, $sql_user_group);
$list_user_group  = mysqli_fetch_all($rs_user_group, MYSQLI_ASSOC);
?>
        ...
        <div class="row gx-7 gy-2">
            ...
            <div class="col-md-6">
                <div class="d-flex flex-column mb-5 fv-row">
                    ...
                    <input type="text" class="form-control form-control-solid" placeholder="" id="user_code" name="user_code" value="<?php echo $row['user_code'] ?>" />
                </div>
            </div>
            ...
            <div class="d-flex flex-column mb-5 fv-row">
                ...
                <select class="form-select form-select-lg form-select-solid" id="user_group" name="user_group[]" data-control="select2" data-placeholder="กรุณาระบุการเข้าถึง" data-allow-clear="true" multiple="multiple">
                    ...
                    while ($row_group  = mysqli_fetch_assoc($rs_group)) {
                        $select = "";
                        if (in_array($row_group['group_id'], array_column($list_user_group, 'group_id'), true)) {
                            $select = 'selected';
                        }
                    ?>

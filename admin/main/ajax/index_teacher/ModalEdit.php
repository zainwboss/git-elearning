...
<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
    <form id="form_edit_admin" class="form">
        <input type="hidden" class="form-control form-control-solid" id="teacher_id" name="teacher_id" value="<?php echo $row['teacher_id'] ?>" />
        <div class="mb-10 text-center">
            <h1 class="mb-3">แก้ไขผู้สอน</h1>
                    ...
                    <div class="row gx-6 gy-md-2">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="fullname" name="fullname" value="<?php echo $row['fullname'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="facebook" name="facebook" value="<?php echo $row['facebook'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="line" name="line" value="<?php echo $row['line'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="linkedin" name="linkedin" value="<?php echo $row['linkedin'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="address" name="address" value="<?php echo $row['address'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-6 gy-md-2">
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="company" name="company" value="<?php echo $row['company'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="department" name="department" value="<?php echo $row['department'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="position" name="position" value="<?php echo $row['position'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="company_address" name="company_address" value="<?php echo $row['company_address'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-6 gy-md-2">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="education_level" name="education_level" value="<?php echo $row['education_level'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="field" name="field" value="<?php echo $row['field'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="experience" name="experience" value="<?php echo $row['experience'] ?>" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" id="certificate" name="certificate" value="<?php echo $row['certificate'] ?>" />
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column mb-5 fv-row">
                            ...
                            <textarea class="ckeditor" id="skill" name="skill"><?php echo $row['skill']  ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center">
            ...
            <button type="button" id="modal_teacher_submit" class="btn btn-sm btn-primary btn-hover-scale" onclick="Edit();">
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: "ajax/index_teacher/Edit.php",
                                data: formData,
                                cache: false,
                                contentType: false,
                                processData: false,
